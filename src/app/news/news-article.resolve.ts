  ...
  public async resolve(
    ...
    const articles = { // TODO: contentful backend support for news space....
      'assembly-summer-2018': {
        ...
        event: "Summer18",
        category: "General",
        date: new Date("Tue Feb 13 2018 18:12:00 UTC+0200"),
        featuredImage: { url: "https://images.ctfassets.net/btkrp9bl56b6/2mOnzD94P2CaYYsAkQy66I/2b86f6ab95f72e3ba2c40d4004859bbf/asmw15-perjantai-tuulaylikorpi_1A1C9599.jpg" }
      }
    };
